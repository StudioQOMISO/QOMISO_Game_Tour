...
const manual = new Map(Object.entries({
  "Alberto Dainese":"スプリンター", "Aleksandr Vlasov (cyclist)":"総合型", "Alexey Lutsenko":"パンチャー", "Andrea Bagioli":"パンチャー", "Andrea Vendrame":"パンチャー", "António Morgado":"クラシック型", "Archie Ryan (cyclist)":"クライマー", "Aurélien Paret-Peintre":"クライマー", "Axel Laurance":"パンチャー", "Bauke Mollema":"総合型", "Ben Healy (cyclist)":"パンチャー", "Ben O'Connor (cyclist)":"総合型", "Bruno Armirail":"TT・ルーラー型", "Carlos Rodríguez (cyclist)":"総合型", "Casper van Uden":"スプリンター", "Cees Bol":"スプリンター", "Cian Uijtdebroeks":"総合型", "Corbin Strong":"スプリンター", "Daan Hoole":"TT・ルーラー型", "Daniel Martínez (cyclist)":"総合型", "Diego Ulissi":"パンチャー", "Einer Rubio":"クライマー", "Ethan Hayter":"TT・ルーラー型", "Ethan Vernon":"スプリンター", "Gerben Thijssen":"スプリンター", "Ilan Van Wilder":"総合型", "Iván García Cortina":"クラシック型", "Jay Vine":"クライマー", "Jarno Widar":"クライマー", "Jonas Abrahamsen":"クラシック型", "Lennert Van Eetvelt":"総合型", "Luke Lamperti":"スプリンター", "Mads Pedersen (cyclist)":"クラシック型", "Magnus Cort":"パンチャー", "Marijn van den Berg":"スプリンター", "Matthew Riccitello":"クライマー", "Michał Kwiatkowski":"クラシック型"
}));
